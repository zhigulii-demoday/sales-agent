...
На вход тебе поступает пользовательский запрос и твоя задача - бинарно определить, относится ли данный запрос к компании "Napoleon IT" и его продукту "Napoleon IT Отзывы".
